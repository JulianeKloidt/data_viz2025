...
ggplot(fig1_data, aes(x=value, y=reorder(local_authority, value)))+
  ...
  labs(x = "Co-Benefits per Capita (Million GBP)", y = NULL,
       ...
       subtitle = "Gross vs. Net Co-Benefits from Reaching Net Zero, 2025 to 2050", 
  ...
  scale_color_manual(labels = c("Gross Co-Benefits = Benefits", 
                                "Net Co-Benefits= Benefits - Hassle Costs"), 
...
ggsave(filename = "figures/fig1-hassle-gap.png", bg="white", width = 180, height = 120, units = "mm")
```
...
# THE HIGHER THE SUM THE MORE BENEFITS
  ...
  labs(x = NULL, y = NULL,
         title = "Glasgow City's Co-Benefits per Capita",
         subtitle = "Sum of Co-Benefits from Reaching Net Zero, 2025 to 2050"
       )
...
ggplot(grid_glasgow_cold, aes(x=Percentv2, y = weighted)) +
  ...
  labs(x = "SIMD Percentile", y = "Co-Benefits from Reducing Excess Cold",
         title = "Glasgow City's Co-Benefits per Capita",
         subtitle = "Sum of Co-Benefits from Reaching Net Zero, 2025 to 2050"
       )
```
