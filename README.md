...
data-viz-competition-2025.Rmd: R script used to generate the four key visualizations.
...
Ensure you have R installed with the following libraries: [tidyverse, sf, viridis].

Run data-viz-competition-2025.Rmd to reproduce the figures.
